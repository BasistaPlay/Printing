...
from Product.models import Color, Product, Rating
...
class Order(models.Model):
    ...
    product_color = models.ForeignKey('Product.Color', on_delete=models.CASCADE, null=True)  # Use get_model to avoid circular import
    ...
    class Meta:
        verbose_name = _("Pasūtījums")
        verbose_name_plural = _("Pasūtījumi")
...
class PurchaseProduct(models.Model):
    ...
    product = models.ForeignKey('Product.Product', on_delete=models.CASCADE)  # Should be Product, not Order
